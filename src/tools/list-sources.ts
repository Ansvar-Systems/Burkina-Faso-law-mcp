...
export async function listSources(
  ...
  return {
    results: {
      sources: [
        {
          name: 'Burkinabe Legal Information Portal',
          authority: 'lawburkinabe.com (Burkinabe Legal Information Portal)',
          url: 'https://www.lawburkinabe.com',
          license: 'Government Open Data',
          coverage:
            'Federal proclamations, regulations, and directives published in the Federal Negarit Gazette. ' +
            'Includes the Constitution of Burkina Faso (1995), major legislative acts from 1995 to present, ' +
