/**
 * Burkina Faso Law PDF Parser
 *
 * Parses text extracted from Burkinabe proclamation PDFs (Federal Negarit Gazette).
...
export function parseBurkina FasoLawHtml(html: string, act: ActIndexEntry): ParsedAct {
  return parsePdfText(html, act);
}
