#!/usr/bin/env tsx
/**
 * Burkina Faso Law MCP -- Census Script
 *
 * Enumerates ALL proclamations, regulations, and directives from lawburkinabe.com.
...
const BASE_URL = 'https://www.lawburkinabe.com';
...
const FEDERAL_CATEGORIES = [
  ...
  'banking-and-monetary-system/national-bank-of-burkinabe',
  ...
  'parliament', 'police', 'president-of-burkinabe', 'prison',
...
async function scrapeCategoryPage(categoryPath: string): Promise<RawLaw[]> {
  ...
  for (const link of links) {
    ...
    if (link.href.startsWith('http') && !link.href.includes('lawburkinabe.com')) continue;
...
async function main(): Promise<void> {
  ...
  console.log('Burkina Faso Law MCP -- Census Script');
  console.log('=================================\n');
  ...
  console.log(`  Jurisdiction:   Burkina Faso (ET)`);
  console.log(`  Source:         ${BASE_URL}`);
