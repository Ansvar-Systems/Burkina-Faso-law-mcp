#!/usr/bin/env tsx
/**
 * Database builder for Burkina Faso Law MCP server.
 *
...
function buildDatabase(): void {
  console.log('Building Burkina Faso Law MCP database...\n');
          ...
          if (extractedRefs.length > 0) {
            ...
            for (const ref of extractedRefs) {
              ...
              const euInsert = insertEuDocument.run(
                ...
                shortName, shortName, eurLexUrl, 'Auto-extracted from Burkinabe statute text',
              );
  ...
  const writeMeta = db.transaction(() => {
    ...
    insertMeta.run('source', 'lawburkinabe.com');
