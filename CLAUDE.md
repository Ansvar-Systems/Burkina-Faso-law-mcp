# Burkina Faso Law MCP Server — Developer Guide
...
Burkina Faso Law MCP server providing Burkinabe legislation search via Model Context Protocol. Strategy A deployment (Vercel, bundled SQLite DB). Covers data protection, cybercrimes, ICT, companies, consumer protection, and other key Acts.
...
- Burkina Faso uses "Section N" for Acts and "Article N" for the Constitution
...
1. `scripts/ingest.ts` -> fetches from Burkina Faso Law -> JSON seed files in `data/seed/`
...
- **Burkina Faso Law** (burkinabelaw.org) -- National Council for Law Reporting
- **License:** Government Open Data
- **Languages:** English (en) is the primary legal language; Swahili (sw) for some documents
- **Coverage:** All Acts of Parliament, subsidiary legislation, Constitution of Burkina Faso 2010, selected case law

## Burkina Faso-Specific Notes

- Burkina Faso uses a common law legal system inherited from British colonial administration
- The Constitution of Burkina Faso 2010 is the supreme law (Article 2)
...
- For the Constitution: "Article N, Constitution of Burkina Faso 2010"
...
- npm package: `@ansvar/burkinabe-law-mcp` with bin entry for stdio
